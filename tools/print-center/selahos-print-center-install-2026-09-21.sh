#!/usr/bin/env bash
# ============================================================
# selahos-print-center-install-2026-09-21
#
# Adds the SelahOS Print Center to a SelahOS system you have ALREADY
# installed (Beta 2.0.1 or later) -- no reinstall needed.
#
#   bash selahos-print-center-install-2026-09-21.sh            install / repair
#   bash selahos-print-center-install-2026-09-21.sh --check    report only, changes nothing
#   bash selahos-print-center-install-2026-09-21.sh --upgrade  full system update first (see below)
#   bash selahos-print-center-install-2026-09-21.sh --extract DIR   just unpack the files to read them
#
